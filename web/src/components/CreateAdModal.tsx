...
//keen-slider para fazer carrousel
//radix de select
...
export function CreateAdModal() {
  ...
  function handleCreatedAd(event: FormEvent) {
    ...
    try {
      ...
      alert("Anúncio criadoo com sucess!");
    } catch (error) {
      console.log(error);
      ...
      <Dialog.Overlay className="bg-black/60 inset-0 fixed">
        <Dialog.Content className="fixed bg-[#2a2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
          ...
          <form onSubmit={handleCreatedAd} className="mt-8 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="name">Como deseja ser chamado</label>
              <Input
                id="name"
                name="name"
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input
                  id="discord"
                  name="discord"
                  placeholder="Como te encontrar no Discord"
                />
              </div>
            </div>
            ...
            <label className="mt-2 flex gap-2 text-sm items-center">
              <Checkbox.Root
                ...
                className="w-6 h-6 p-1 rounded bg-zing-900"
              >
                <Checkbox.Indicator>
